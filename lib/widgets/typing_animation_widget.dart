  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: MediaQuery.of(context).platformBrightness == Brightness.light ? const Color.fromARGB(255, 225, 247, 237) : const Color.fromARGB(255, 45, 67, 83),
  ...
  Widget _buildDot(Animation<double> animation) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        double translateY = 4 * (0.25 - animation.value); // Start from bottom
